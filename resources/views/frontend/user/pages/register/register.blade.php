...
<body class="form-v9">
	<div class="page-content">
        <div class="form-v9-content" style="background-image: url('img/userReg/form-v9.jpg')">
			...
			<form action="{{ route('userRegProcess') }}" method="POST" class="form-detail" enctype="multipart/form-data">
				{{ csrf_field() }}
				...
				<h2>User Registration Form</h2>
					...
					@if (session()->has('message'))  
						<h3 style="color: aqua;margin-bottom:25px;margin-left: 20px;font-size: x-large">
							{{ session('message')}}
						</h3>
					@endif 
					{{-- ---------------- X -------------------- --}}
